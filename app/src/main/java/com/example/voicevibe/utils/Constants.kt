...
object Constants {
    ...
    const val BASE_URL = "http://10.206.44.136:8000/api/v1/" // For physical device (replace with your IP)
    ...
    const val WS_BASE_URL = "ws://10.206.44.136:8000/ws/" // For physical device
